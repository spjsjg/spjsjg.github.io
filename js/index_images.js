...
var imgurl5 = "images/"
var imgurl6 = "https://cdn.jsdelivr.net/gh/spjsjg/images-2020@master/"
var str=new Array();
var str1=new Array();
var str2=new Array();
var str3=
...
//	str2[i]='<img class="example-image" src="'+imgurl4_1+'index%2Fthumb%2F'+String(i)+'.jpg'+imgurl4_2+'" alt=""/>'
	str1[i]='<a class="example-image-link" href="'+imgurl6+'index/'+String(i)+'.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward.">'
	str2[i]='<img class="example-image" src="'+imgurl6+'index/thumb/'+String(i)+'.jpg" alt=""/>'
