...
var imgurl2021_api_repo = "https://api.github.com/repos/spjsjg/images-2021/contents/"
...
xhttp2021.open("GET", imgurl2021_api_repo+"images", true);
xhttp2021.setRequestHeader("Accept","application/vnd.github.v3+json")
xhttp2021.send();

function deal_with2021(xml) {
	contents = xml.responseText;
	var line = JSON.parse(contents);
	var gl2021 = ""
